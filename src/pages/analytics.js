...
import AnalyticsRow from '../components/analyticsSection/AnalyticsRow';
import btcLogo from '../../public/btcLogo.svg';

const DynamicPriceBtc = dynamic(() => import('../components/commom/PriceBtc'), { ssr: false });
  ...
  return (
    <main className="h-57rem flex flex-col justify-center items-center">
      ...
      <div className="w-full px-28 mt-36 h-full mb-0">
        ...
        <h1 className="mx-auto pl-2 my-12 text-3xl font-extrabold tracking-wide">Covered Call Analytics</h1>
        ...
        <div className="mt-16 px-2 analytics-table">
          <div>
            ...
            {rowData.map((rowDataItem, index) => (
              <AnalyticsRow key={`row-${index}`} rowData={rowDataItem} />
            ))}

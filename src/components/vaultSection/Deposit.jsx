        ...
        <div className="flex flex-col w-full p-28 px-20 pb-0">
            <div className="dw-tabs">
                <ul className="flex justify-start text-base list-none">
                    <li
                        className={`flex text-lg items-center my-4 mx-6 dw-tab-deposit before:block before:content before:bg-arrow-up before:bg-no-repeat before:w-10 before:h-10 ${isDepositing ? 'before:-rotate-180 font-semibold' : 'cursor-pointer before:rotate-0'
                    ...
                    <li
                        className={`flex text-lg items-center my-4 mx-6 dw-tab-deposit before:block before:content before:bg-arrow-up before:bg-no-repeat before:w-10 before:h-10 ${isDepositing ? 'cursor-pointer before:rotate-0 ' : 'before:-rotate-180 cursor-pointer font-semibold'
                            } hover:cursor-pointer `}
                ...
                <div className="relative flex flex-col justify-between p-12 text-white dw-box">
                    <div className="flex justify-between w-ful dw-box-title">
                        <div className="dw-box-main-title">
                            ...
                            <p className="text-base text-white font-medium tracking-widest">Balance: 0 BTC</p>
                        </div>
                        <div className="flex flex-col items-end justify-evenly">
                            <p className="text-sm font-medium tracking-widest text-gray-500">auto-compound in</p>
                    ...
                    <button className="m-auto h-16 w-72 mt-4 rounded-3xl mx-auto text-lg font-semibold tracking-widest text-white bg-transparent border border-white cursor-pointer" style={{ fontSize: "1.6rem" }}>
                ...
                <div className="flex flex-col justify-between h-42rem w-2/4 p-12 rounded-39rem border border-white vault-balance dw-box-second">
                    ...
                    <div className="vault-total-deposits-bar-container mb-8 2rem; ml-8">
                        <div className="w-full h-3 bg-white rounded-md">
                            <div className="vault-total-deposits-bar-fill h-3 width: 4.59304%"></div>
                            <div className="my-2 text-base font-normal tracking-wider pb-4 ">Total: 0.0459 of 1 BTC</div>
                        </div>
                    </div>
                </div>
            </div>
